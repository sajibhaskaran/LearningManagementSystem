...
// Action
import { postPageEditField } from '../../actions/Course Designer/page_field_edit_post_action';

class PageFieldEdit extends Component {
    constructor(props) {
        super(props);
    ...
    setSingleFieldState(type, value) {
        ...
        this.setState((prevState) => {
            ...
            const field = {
                PageFieldId: this.props.SelectedField.PageFieldId,
    ...
    onFieldNumberChange(event) {
        ...
        this.setSingleFieldState("FieldNumber", value);
    }
    ...
    onFormSubmit() {
        ...
        this.props.postPageEditField(this.state.Field);

    }

    componentDidMount() {

        if (this.RouteError === true || this.props.SelectedField === null) {
            window.location.hash = "#/CourseDesigner";
            return;
        }

        // Set the props state
        this.setState({ Field: this.props.SelectedField });
    }
...
function mapDispatchToProps(dispatch) {
    return bindActionCreators(
        {
            postPageEditField: postPageEditField,

        },
        dispatch);
}

export default connect(mapStateToProps, mapDispatchToProps)(PageFieldEdit);